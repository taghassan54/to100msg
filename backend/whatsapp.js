...
const getSession = (_0x41e565) => {
  ...
  sentWebHook = (_0x3e6039, _0x56c4e1) => {
    ...
    console.log(`****************************************************`);
    console.log("sentWebHookUrl", sentWebHookUrl);
    console.log("data : ", {
    ...
    try {
      ...
      _0x5e2a90[_0x3aa6a9(0x1c2)](sentWebHookUrl, {
        ...
        [_0x3aa6a9(0x1ac)](function(result) {

        try {

          if (result && result.data && result.data.session_id && result.data.receiver && result.data.message) {
            const session = getSession(result["data"]["session_id"]);
            if (result["status"] == 0xc8) {
              const session = getSession(result["data"]["session_id"]);
        ...
        console["error"](_0x54e0f8 && _0x54e0f8.response && _0x54e0f8.response.data && _0x54e0f8.response.data);
      });
    } catch (e) {
  ...
  getChatList = (sessionId, _0x15dc87 = ![]) => {

    const _0x850fb2 = _0x130c,
      _0x50f97b = _0x15dc87 ? _0x850fb2(0x1b1) : "@s.whatsapp.net";
    return getSession(sessionId)[_0x850fb2(0x1b7)]["chats"][_0x850fb2(0x1c4)](
      (_0x4a0d5c) => {
