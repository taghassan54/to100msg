...
echo _gettext("Continue");
    ...
    {
        return new Source("", "database/structure/bulk_action_modal.twig", "/var/www/to100msg.online/wasender/phpmyadmin/templates/database/structure/bulk_action_modal.twig");
    }
}
