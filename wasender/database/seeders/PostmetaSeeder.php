...
class PostmetaSeeder extends Seeder
{
  ...
  array('id' => '23','post_id' => '9','key' => 'seo','value' => '{"title":"Click to Chat ads on WhatsApp- A vital tool for your marketing arsenal","description":"In the competitive business landscape, if there\\u2019s one thing that has led to the massive growth of internet businesses, it is digital advertising. The $600 billion industry holds an outsized control on customers\\u2014- who buys what and thus to the fortunes of these businesses. An interesting aspect of digital advertising is its dynamic and ever-evolving nature, from search ads to video and voice search with the latest being Click to Chat ads. Click to Chat ads, although at a nascent stage currently,","tags":"wa, whatsapp, devstation, Zero To 100, whatsserve","image":"\\/uploads\\/23\\/03\\/1678129064ZCzwbv9lHINvkGVXBH2R.png"}'),
  ...
  array('id' => '54','post_id' => '21','key' => 'excerpt','value' => 'WA Bulk messaging is the dissemination of large numbers of messages for delivery to Zero To 100 software. It is used by media companies, banks and other enterprises and consumer brands for a variety of purposes including entertainment, enterprise and mobile marketing.'),
  ...
  array('id' => '62','post_id' => '23','key' => 'excerpt','value' => 'Zero To 100 is the best quaint james bond victoria sponge happy days cras.'),
  array('id' => '63','post_id' => '24','key' => 'excerpt','value' => 'No you can simply register with your email'),
  array('id' => '64','post_id' => '25','key' => 'excerpt','value' => 'Zero To 100 has supported free 10 days trial. You don\'t need to add credit card information.'),
